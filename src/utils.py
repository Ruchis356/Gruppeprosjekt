...
# This block of code was suggested and generated by AI (DeepSeek)
try:
...
class VisualTable:
    ...
    def pretty_data(self, df):
        ...
        # SAFER DATE FORMATTING - handles more edge cases
        if 'Date' in formatted_df.columns:
            try:
                ...
                # Format as date string (keeps as string rather than date object)
