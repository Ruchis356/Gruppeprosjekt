...
class WeatherAnalyser:
    ...
    def load_and_merge_data(self, df_weather, df_quality, weather_vars, pollutant_vars, mode='train'):
        ...
        for pollutant in pollutant_vars:
            ...
            print('') # This is only for readability of print reasons
    ...
    def predict_future(self, model, last_date, days_to_predict):
        ...
        # Adding the following warning was suggested by and refined with the help of AI (DeepSeek)
        if hasattr(model, 'feature_names_in_') and 'DayOfYear' not in model.feature_names_in_:
            self.logger.warning(
                ...
                "as only 'DayOfYear' is provided. Consider using `train_model` "
                "with a matching feature set.", 
